...
export default function FormularioRegistro({ contadorLugares, onExito }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Validar teléfonos extra si están llenos
    ...
    // Validar WhatsApp si no usa el mismo número
    ...
    try {
      // Agregar logo en base64 si existe
      const datosConLogo = {
        ...datos,
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-xl border-2 border-slate-200 dark:border-slate-700">
